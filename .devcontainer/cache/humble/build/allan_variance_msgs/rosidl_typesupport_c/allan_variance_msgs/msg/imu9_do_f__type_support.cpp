...
static const _Imu9DoF_type_support_symbol_names_t _Imu9DoF_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, allan_variance_msgs, msg, Imu9DoF)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, allan_variance_msgs, msg, Imu9DoF)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, allan_variance_msgs, msg, Imu9DoF)() {
  return &::allan_variance_msgs::msg::rosidl_typesupport_c::Imu9DoF_message_type_support_handle;
}
